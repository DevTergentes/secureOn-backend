...
@RequestMapping("/api/secureon/v1/records")
public class RecordController {
    ...
    public ResponseEntity<RecordLog> getLatestRecord(@PathVariable Long deliveryId) {
        return recordService.getLatestRecordByDeliveryId(deliveryId)
